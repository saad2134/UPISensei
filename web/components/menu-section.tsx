...
import { Mail, Phone, User, LogOut, Sun, Moon, Monitor, Palette } from 'lucide-react'
...
export default function MenuSection() {
    ...
    return (
      <div className="flex items-center justify-center h-96">
        <div className="text-center">
          ...
          <p className="text-muted-foreground mb-6">Please log in to view your menu</p>
  ...
  return (
    <div className="space-y-6">
      <div className="bg-card border border-border rounded-2xl p-8 shadow-lg dark:bg-gray-800 dark:border-gray-700">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div className="bg-muted/50 border border-border rounded-xl p-4 dark:bg-gray-700/50 dark:border-gray-600">
          ...
          <div className="bg-muted/50 border border-border rounded-xl p-4 md:col-span-2 dark:bg-gray-700/50 dark:border-gray-600">
            <div className="flex items-start gap-3">
      ...
      <div className="bg-card border border-border rounded-2xl p-6 shadow-lg dark:bg-gray-800 dark:border-gray-700">
          ...
          <button
            ...
            className={`flex flex-col items-center gap-2 p-4 rounded-xl border-2 transition-all ${
              theme === 'light' 
                ...
                : 'border-border hover:border-primary/50 dark:border-gray-600'
            }`}
          >
      ...
      <div className="bg-card border border-border rounded-2xl p-6 shadow-lg dark:bg-gray-800 dark:border-gray-700">
        ...
        <div className="grid grid-cols-3 gap-4">
          <div className="text-center p-4 rounded-lg bg-primary/5 border border-primary/20 dark:bg-primary/10 dark:border-primary/30">
            <p className="text-2xl font-bold text-primary">5</p>
            <p className="text-xs text-muted-foreground mt-1">Transactions</p>
          </div>
          <div className="text-center p-4 rounded-lg bg-secondary/5 border border-secondary/20 dark:bg-secondary/10 dark:border-secondary/30">
            <p className="text-2xl font-bold text-secondary">₹ 2,450</p>
            <p className="text-xs text-muted-foreground mt-1">Total Spent</p>
          </div>
          <div className="text-center p-4 rounded-lg bg-accent/5 border border-accent/20 dark:bg-accent/10 dark:border-accent/30">
